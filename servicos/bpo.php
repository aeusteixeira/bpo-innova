<?php
$page_title = 'BPO Financeiro - BPO Innova';
$page_content = '
    <!-- Hero Section -->
    <section id="hero" class="hero">
        <div class="hero-bg-bpo" role="img" aria-label="Capa com visual moderno e abstrato"></div>
    ...
    <!-- Seção: BPO Contábil e Fiscal como Ferramenta Estratégica -->
        ...
        <div class="h-100">
            <div class="row align-items-center h-100">
                ...
                <div class="col-lg-6 h-100">
                    <div class="h-100">
                        <img src="../img/servicos/contabil-fiscal.jpg"
                             alt="BPO Contábil e Fiscal"
    ...
    <!-- Seção: BPO Financeiro com Visibilidade e Controle Total do seu Fluxo de Caixa -->
    <section style="height: 100vh; display: flex; align-items: center; background-color: #f8f9fa; padding-left: 40px;">
        <div class="h-100">
            <div class="row align-items-center h-100">
                ...
                <div class="col-lg-6 h-100">
                    <div class="h-100">
                        <img src="../img/servicos/bpo-financeiro.jpg"
                             alt="BPO Financeiro"
                             class="img-fluid img-efeito w-100 h-100"
                             >
                    </div>
     ...
     <!-- Seção: BPO de Folha de Pagamento com Precisão, Conformidade e Cuidado com seu Capital Humano -->
     <section style="height: 100vh; display: flex; align-items: center; padding-right: 40px;">
       <div class="h-100">
         <div class="row align-items-center h-100">
           <!-- Coluna 1: Imagem -->
           <div class="col-lg-6 h-100">
             <div class="h-100">
               <img src="../img/servicos/folha.jpg"
                    alt="BPO de Folha de Pagamento"
                    class="img-fluid img-efeito w-100 h-100"
                    >
             </div>
           </div>
