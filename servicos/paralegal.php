<?php
$page_title = 'Paralegal - BPO Innova';
$page_content = '
    <!-- Hero Section -->
    <section id="hero" class="hero">
        <div class="hero-bg-paralegal" role="img" aria-label="Capa com visual moderno e abstrato"></div>
        ...
        <div class="h-100">
            <div class="row align-items-center h-100">
                ...
                <div class="col-lg-6 h-100">
                    <div class="h-100">
                        <img src="../img/servicos/paralegal/abertura-empresa.jpg"
                             alt="Abertura de Empresa - Serviços Paralegais"
    ...
    <section style="height: 100vh; display: flex; align-items: center; background-color: #f8f9fa; padding-left: 40px;">
        <div class="h-100">
            <div class="row align-items-center h-100">
                ...
                <div class="col-lg-6 h-100">
                    <div class="h-100">
                        <img src="../img/servicos/paralegal/encerramento-empresa.jpg"
                             alt="Encerramento de Empresa - Serviços Paralegais"
                             class="img-fluid img-efeito w-100 h-100"
                             >
                    </div>
                </div>
    ...
    <section style="height: 100vh; display: flex; align-items: center; padding-right: 40px;">
        <div class="h-100">
            <div class="row align-items-center h-100">
                ...
                <div class="col-lg-6 h-100">
                    <div class="h-100">
                        <img src="../img/servicos/paralegal/alvara-de-funcionamento.jpg"
                             alt="Alvará de Funcionamento - Serviços Paralegais"
                             class="img-fluid img-efeito w-100 h-100"
                             >
                    </div>
                </div>
    ...
    <!-- Seção: Registro de Alterações Contratuais -->
    <section style="height: 100vh; display: flex; align-items: center; background-color: #f8f9fa; padding-left: 40px;">
        <div class="h-100">
            <div class="row align-items-center h-100">
                <!-- Coluna 1: Texto -->
                ...
                <div class="col-lg-6 h-100">
                    <div class="h-100">
                        <img src="../img/servicos/paralegal/registro-de-alteracoes-contratuais.jpg"
                             alt="Registro de Alterações Contratuais - Serviços Paralegais"
                             class="img-fluid img-efeito w-100 h-100"
                             >
                    </div>
                </div>
    ...
    <!-- Seção: Registro nos Órgãos Competentes -->
    <section style="height: 100vh; display: flex; align-items: center; padding-right: 40px;">
        <div class="h-100">
            <div class="row align-items-center h-100">
                <!-- Coluna 1: Imagem -->
                <div class="col-lg-6 h-100">
                    <div class="h-100">
                        <img src="../img/servicos/paralegal/registro-nos-orgaos-competentes.jpg"
                             alt="Registro nos Órgãos Competentes - Serviços Paralegais"
                             class="img-fluid img-efeito w-100 h-100"
                             >
                    </div>
                </div>
